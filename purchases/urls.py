...
urlpatterns = [
    ...
    path('solicitacoes/<int:pk>/relatorio/pdf/', views.PurchaseRequestReportPdfView.as_view(), name='request_report_pdf'),
    ...
    path('cotacoes/<int:pk>/relatorio/pdf/', views.QuotationReportPdfView.as_view(), name='quotation_report_pdf'),
    ...
    path('ordens/<int:pk>/relatorio/pdf/', views.PurchaseOrderReportPdfView.as_view(), name='order_report_pdf'),
