...
urlpatterns = [
    ...
    path('<int:project_id>/diario/<int:pk>/excluir/', views.DailyLogDeleteView.as_view(), name='daily_log_delete'),
    ...
    path('<int:project_id>/tarefa/<int:pk>/excluir/', views.ProjectTaskDeleteView.as_view(), name='task_delete'),
    ...
    path('<int:project_id>/medicao/<int:pk>/excluir/', views.PhysicalMeasurementDeleteView.as_view(), name='measurement_delete'),
]
